...
class BudgetTest < ActiveSupport::TestCase
  ...
  test "should update balances" do
    ...
    # Switched budget to January
    initial_month = "2018-01-15".to_date
    travel_to initial_month
    budget = Budget.new(current_month: initial_month)
    ...
    # Switched budget to February
    next_month = "2018-02-01".to_date
    travel_to next_month
    budget.current_month = next_month
    assert_equal 83000.0, budget.available_for_budget
    assert_equal 10000.0, budget.find_budget_balance(groceries).balance
    assert_equal 500.0, budget.find_budget_balance(apps).balance

    # Added 50000 to groceries
    ...
    # Moved 10000 from groceries into apps

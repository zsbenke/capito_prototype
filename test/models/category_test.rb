...
class CategoryTest < ActiveSupport::TestCase
  ...
  test "should calculate balance until a date" do
    ...
    assert_equal balance_until_january, category.balance(until_date: "2018-01-31".to_date)
    assert_equal balance_until_february, category.balance(until_date: "2018-02-28".to_date)
    assert_equal balance_until_march, category.balance(until_date: "2018-03-31".to_date)
